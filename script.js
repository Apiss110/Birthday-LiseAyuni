...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Dec 14, 2025 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Hari ini, kaka langitkan semua doa terbaik kaka untuk dede.", "Semoga hal-hal yang membuat dede runtuh turut menjadi alasan dede untuk tetap tumbuh.", "Semoga dunia senantiasa menjaga dde dimanapun dede berada.", "Semoga hari-hari dede selalu diiringi cinta yang tak pernah ada batasnya." , "Semoga setiap langkah dde dimudahkan hingga tercapai apa yang dde inginkan."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Dengan ataupun tanpa kaka, semoga semesta selalu membahagiakan dde bagaimanapun caranya.", " ", "barakallah fi umrik, terima kasih sudah bertahan sampai sejauh ini.", " ", "- Wish you all the best"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
...
new TypeIt("#trims", {
  strings: ["Terimakasih adee sayangg."],
  startDelay: 2000,
  speed: 150,
  loop: false,
  waitUntilVisible: true,
